  ...
  return (
    ...
    >
      <div className="flex w-full basis-2/5 flex-col gap-4">
        <h2 className=" text-center  text-lg tracking-wide text-primary-400 lg:text-left">
          CONTATO
        </h2>
        <h1 className=" text-center text-4xl font-bold leading-none text-white md:text-5xl lg:text-left">
          Fale Comigo
        </h1>
